async function Copypasta() {
    ...
    */
    const Copypasta = [
        ...
        `Sometimes I fantasize about Misato coming home drunk and beating me until I feel numb. She kicks me in the ribs until I can hardly breathe.
        Then she starts to cry and apologizes, begging me to forgive her. She holds me all night as I gently cry into her t-shirt. Please help is 
        there any hope for me `,

        `Transformers 4 is without a doubt, THE worst cinema experience i've EVER had.
        ...
        There is… no saving grace to this movie, nothing good about it. No character is not a cliche. Every word the ugly CGI transformers utter is so brainlessly macho, that I'd be expecting 12 year old boys to be facepalming themselves.
        ...
        “Annihilate your species”

        And all the time you’re watching, Michael Bay is continually flashing these lights in your eyes, as though he’s trying to give you a seizure! And the shaky cam that just never stops! It jumbles around so much that there’s no point trying to make out what you’re actually seeing! This movie could EASILY be compressed into 10 minutes, but it was THE longest 3 hours of cinema i have EVER SAT THROUGH!

        This movie is quite literally 3 hours of absolutely nothing happening except explosions and exploitation of the audience. After seeing Transformers 4, I think something died in me. It took me another 6 months before I ever DARED to go to the cinema again! There’s no keeping up with the story. Every character looks like the same prescribed, Macho White Calvin Klein model. The only thing I remember from seeing this movie is that Kelsey Grammer from Frasier played the villain. The word “shallow” does NOT do justice to this movie’s level of emptiness, because the endless cycle of shaky cam, explosions and green-screen CG begins, and it doesn’t stop until you’ve either walked out or passed out, and the tragic part of it all? They keep selling, since there’s, again, that element of familiarity many people have with the Transformers, it’ll often win out against much higher quality movies we know nothing about. Why was the movie set in Hong Kong? Purley so they could capitalise on the Chinese box office. I hate that this movie and the traumatic effects the other movies have had on modern cinema. I personally consider it the worst live-action cartoon remake of all time, no sympathy.`,
    ...
    index = Math.floor(Math.random() * Copypasta.length);
    document.getElementById("CopypastaTextDisplay").innerHTML = Copypasta[index];
